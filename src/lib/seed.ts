...
export function seed() {
  ...
  const pipeline: Array<Partial<Person> & Pick<Person, "first_name" | "last_name" | "stage">> = [
    ...
    },
    {
      ...
      stage: "next_steps",
      lead_source: "family",
      caller_name: "Ada Adeyemi",
      resident_name: "Ben Adeyemi",
      next_of_kin_name: "Ada Adeyemi",
      next_of_kin_phone: "021 555 0299",
      arp_email: "ada.adeyemi@example.invalid",
      addon_overnight_supervision: 1,
      addon_detox_overnight: 1,
